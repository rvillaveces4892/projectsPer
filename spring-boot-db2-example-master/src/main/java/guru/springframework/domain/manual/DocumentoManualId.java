...
/**
 * DocumentoManualId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class DocumentoManualId implements java.io.Serializable{
    
    /**
     * 
     */
    private static final long serialVersionUID=945895941187420306L;
    ...
    /** default constructor */
    public DocumentoManualId(){
    }

    /** full constructor */
    public DocumentoManualId(Long identificacionObligado,String noDocumento,Long numResoluDian,Short idTipoDocFe){
    ...
    public boolean equals(Object other){
        ...
        if((other==null))
            return false;
        if(!(other instanceof DocumentoManualId))
            return false;
        DocumentoManualId castOther=(DocumentoManualId)other;
