...
/**
 * DescuentoDocumentoManualId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class DescuentoDocumentoManualId implements java.io.Serializable{

    /**
     * 
     */
    private static final long serialVersionUID=4260475207495356078L;
    
    // Fields

    private Integer noLineaDescuento;
    ...
    /** default constructor */
    public DescuentoDocumentoManualId(){
    }

    /** full constructor */
    public DescuentoDocumentoManualId(Integer noLineaDescuento,Long identificacionObligado,String noDocumento,Long numResoluDian,Short idTipoDocFe){
        this.noLineaDescuento=noLineaDescuento;
    ...
    @Column(name="NO_LINEA_DESCUENTO",nullable=false)
    public Integer getNoLineaDescuento(){
        return this.noLineaDescuento;
    }

    public void setNoLineaDescuento(Integer noLineaDescuento){
        this.noLineaDescuento=noLineaDescuento;
    }
    ...
    public boolean equals(Object other){
        ...
        if((other==null))
            return false;
        if(!(other instanceof DescuentoDocumentoManualId))
            return false;
        DescuentoDocumentoManualId castOther=(DescuentoDocumentoManualId)other;

        return ((this.getNoLineaDescuento()==castOther.getNoLineaDescuento())||(this.getNoLineaDescuento()!=null&&castOther.getNoLineaDescuento()!=null&&this.getNoLineaDescuento().equals(castOther.getNoLineaDescuento())))
                &&((this.getIdentificacionObligado()==castOther.getIdentificacionObligado())||(this.getIdentificacionObligado()!=null&&castOther.getIdentificacionObligado()!=null&&this.getIdentificacionObligado().equals(
                        castOther.getIdentificacionObligado())))&&((this.getNoDocumento()==castOther.getNoDocumento())||(this.getNoDocumento()!=null&&castOther.getNoDocumento()!=null&&this.getNoDocumento().equals(castOther.getNoDocumento())))
    ...
    public int hashCode(){
        ...
        result=37*result+(getNoLineaDescuento()==null?0:this.getNoLineaDescuento().hashCode());
