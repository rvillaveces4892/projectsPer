...
/**
 * CargosDocumentoFeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class CargosDocumentoFeId   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=155653542032193608L;
    private Long identificacionObligado;
     private String noDocumento;
     private Long numResoluDian;
     private Integer idCargoDoc;
    ...
    /** default constructor */
    public CargosDocumentoFeId() {
    }

    
    /** full constructor */
    public CargosDocumentoFeId(Long identificacionObligado, String noDocumento, Long numResoluDian, Integer idCargoDoc, Short idTipoDocFe) {
        this.identificacionObligado = identificacionObligado;
        this.noDocumento = noDocumento;
        this.numResoluDian = numResoluDian;
        this.idCargoDoc = idCargoDoc;
    ...
    @Column(name="ID_CARGO_DOC", nullable=false)

    public Integer getIdCargoDoc() {
        return this.idCargoDoc;
    }
    
    public void setIdCargoDoc(Integer idCargoDoc) {
        this.idCargoDoc = idCargoDoc;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CargosDocumentoFeId) ) return false;
		 CargosDocumentoFeId castOther = ( CargosDocumentoFeId ) other; 
 ...
 && ( (this.getIdCargoDoc()==castOther.getIdCargoDoc()) || ( this.getIdCargoDoc()!=null && castOther.getIdCargoDoc()!=null && this.getIdCargoDoc().equals(castOther.getIdCargoDoc()) ) )
 && ( (this.getIdTipoDocFe()==castOther.getIdTipoDocFe()) || ( this.getIdTipoDocFe()!=null && castOther.getIdTipoDocFe()!=null && this.getIdTipoDocFe().equals(castOther.getIdTipoDocFe()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getIdCargoDoc() == null ? 0 : this.getIdCargoDoc().hashCode() );
