...
/**
 * DescuentosDocumentoFeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class DescuentosDocumentoFeId   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=-3392085278404486003L;
    private Long identificacionObligado;
     private String noDocumento;
     private Long numResoluDian;
     private Integer idDescuentoDoc;
    ...
    /** default constructor */
    public DescuentosDocumentoFeId() {
    }

    
    /** full constructor */
    public DescuentosDocumentoFeId(Long identificacionObligado, String noDocumento, Long numResoluDian, Integer idDescuentoDoc, Short idTipoDocFe) {
        this.identificacionObligado = identificacionObligado;
        this.noDocumento = noDocumento;
        this.numResoluDian = numResoluDian;
        this.idDescuentoDoc = idDescuentoDoc;
    ...
    @Column(name="ID_DESCUENTO_DOC", nullable=false)

    public Integer getIdDescuentoDoc() {
        return this.idDescuentoDoc;
    }
    
    public void setIdDescuentoDoc(Integer idDescuentoDoc) {
        this.idDescuentoDoc = idDescuentoDoc;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DescuentosDocumentoFeId) ) return false;
		 DescuentosDocumentoFeId castOther = ( DescuentosDocumentoFeId ) other; 
 ...
 && ( (this.getIdDescuentoDoc()==castOther.getIdDescuentoDoc()) || ( this.getIdDescuentoDoc()!=null && castOther.getIdDescuentoDoc()!=null && this.getIdDescuentoDoc().equals(castOther.getIdDescuentoDoc()) ) )
 && ( (this.getIdTipoDocFe()==castOther.getIdTipoDocFe()) || ( this.getIdTipoDocFe()!=null && castOther.getIdTipoDocFe()!=null && this.getIdTipoDocFe().equals(castOther.getIdTipoDocFe()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getIdDescuentoDoc() == null ? 0 : this.getIdDescuentoDoc().hashCode() );
