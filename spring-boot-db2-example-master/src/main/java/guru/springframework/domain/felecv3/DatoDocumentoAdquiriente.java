...
/**
 * DatoDocumentoAdquiriente entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="DATO_DOCUMENTO_ADQUIRIENTE"
    ,schema="FELECV3"
)

public class DatoDocumentoAdquiriente   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=-379379089831689998L;
    private DatoDocumentoAdquirienteId id;
    ...
    /** default constructor */
    public DatoDocumentoAdquiriente() {
    }

	/** minimal constructor */
    public DatoDocumentoAdquiriente(DatoDocumentoAdquirienteId id, AdquirienteFe adquirienteFe, ObligadoFe obligadoFe) {
        this.id = id;
    ...
    /** full constructor */
    public DatoDocumentoAdquiriente(DatoDocumentoAdquirienteId id, AdquirienteFe adquirienteFe, PaisFe paisFe, TipoRegimenFe tipoRegimenFe, ObligadoFe obligadoFe, TipoDocIdentificacion tipoDocIdentificacion, TipoPersona tipoPersona, String razonSocial, String direccion, String ciudad, String departamento, String subdivision, String email, String nombrePn, String nombre2Pn, String apellidoPn, Timestamp fechaCargue) {
        this.id = id;
        this.adquirienteFe = adquirienteFe;
        this.paisFe = paisFe;
    ...
    public DatoDocumentoAdquirienteId getId() {
        return this.id;
    }
    
    public void setId(DatoDocumentoAdquirienteId id) {
        this.id = id;
    }
    ...
    @Column(name="FECHA_CARGUE", length=26)
