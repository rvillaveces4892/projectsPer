...
/**
 * DetalleDocumentoFeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class DetalleDocumentoFeId   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=5771212875253958259L;
    ...
    /** default constructor */
    public DetalleDocumentoFeId() {
    }

    
    /** full constructor */
    public DetalleDocumentoFeId(Integer idDetalleDoc, Long identificacionObligado, String noDocumento, Long numResoluDian, Short idTipoDocFe) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DetalleDocumentoFeId) ) return false;
		 DetalleDocumentoFeId castOther = ( DetalleDocumentoFeId ) other; 
         
		 return ( (this.getIdDetalleDoc()==castOther.getIdDetalleDoc()) || ( this.getIdDetalleDoc()!=null && castOther.getIdDetalleDoc()!=null && this.getIdDetalleDoc().equals(castOther.getIdDetalleDoc()) ) )
