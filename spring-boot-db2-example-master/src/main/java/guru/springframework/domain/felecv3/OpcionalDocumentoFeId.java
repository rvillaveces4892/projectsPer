...
/**
 * OpcionalDocumentoFeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class OpcionalDocumentoFeId   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=178882557149014918L;
    ...
    /** default constructor */
    public OpcionalDocumentoFeId() {
    }

    
    /** full constructor */
    public OpcionalDocumentoFeId(Long identificacionObligado, String noDocumento, Long numResoluDian, Short idCampoOpcionalDoc, Short idTipoDocFe) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof OpcionalDocumentoFeId) ) return false;
		 OpcionalDocumentoFeId castOther = ( OpcionalDocumentoFeId ) other; 
