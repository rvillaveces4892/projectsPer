...
/**
 * ImpuestoDocumentoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class ImpuestoDocumentoId   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=4378782153638207374L;
    private Long identificacionObligado;
     private String noDocumento;
     private Long numResoluDian;
     private Integer idImpuestoDoc;
    ...
    /** default constructor */
    public ImpuestoDocumentoId() {
    }

    
    /** full constructor */
    public ImpuestoDocumentoId(Long identificacionObligado, String noDocumento, Long numResoluDian, Integer idImpuestoDoc, Short idTipoDocFe) {
        this.identificacionObligado = identificacionObligado;
        this.noDocumento = noDocumento;
        this.numResoluDian = numResoluDian;
        this.idImpuestoDoc = idImpuestoDoc;
    ...
    @Column(name="ID_IMPUESTO_DOC", nullable=false)

    public Integer getIdImpuestoDoc() {
        return this.idImpuestoDoc;
    }
    
    public void setIdImpuestoDoc(Integer idImpuestoDoc) {
        this.idImpuestoDoc = idImpuestoDoc;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ImpuestoDocumentoId) ) return false;
		 ImpuestoDocumentoId castOther = ( ImpuestoDocumentoId ) other; 
 ...
 && ( (this.getIdImpuestoDoc()==castOther.getIdImpuestoDoc()) || ( this.getIdImpuestoDoc()!=null && castOther.getIdImpuestoDoc()!=null && this.getIdImpuestoDoc().equals(castOther.getIdImpuestoDoc()) ) )
 && ( (this.getIdTipoDocFe()==castOther.getIdTipoDocFe()) || ( this.getIdTipoDocFe()!=null && castOther.getIdTipoDocFe()!=null && this.getIdTipoDocFe().equals(castOther.getIdTipoDocFe()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getIdImpuestoDoc() == null ? 0 : this.getIdImpuestoDoc().hashCode() );
