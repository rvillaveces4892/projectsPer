...
/**
 * DatoDocumentoAdquirienteId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class DatoDocumentoAdquirienteId   extends EntidadPaginacion implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID=-797261603291148166L;
    ...
    /** default constructor */
    public DatoDocumentoAdquirienteId() {
    }

    
    /** full constructor */
    public DatoDocumentoAdquirienteId(Long identificacionObligado, String noDocumento, Long numResoluDian, Short idTipoDoc) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DatoDocumentoAdquirienteId) ) return false;
		 DatoDocumentoAdquirienteId castOther = ( DatoDocumentoAdquirienteId ) other; 
